...
that java would come across my path somehow in the foreseeable future. Java is a popular language and provides a clean and efficient object-oriented-based development platform.
...
Spring is the most popular framework for Java and is most identified with dependency injection flavor of inversion of control, which I learned last year and I am willing to put to use again in this project.
...
In this diagram you can see that the user has access to the dashboardSPA. He has the possibility to Browse all sensordata from the browser when authorized by the login provider Auth0.

![Container diagram](https://user-images.githubusercontent.com/48807736/143461583-e95969fe-f4a4-47aa-9005-43e8e28d0124.png)

### C3 Component Model
In this model you can see which services the client uses, if a user makes a request, it goes trough the controller that allows the user to use the sensor data, the data access component will provide the functionality related to signing in and sensor data storage.
...
Whith Sonarcloud I can continuously monitor code quality during my development. Sonarcloud analyzes my code everytime I push to my develop branch. (You can change these settings in your [workflow](https://docs.github.com/en/actions/quickstart))
...
When clicking on 'why is this an issue?' it gives you a reasoning for the occurred bug.
